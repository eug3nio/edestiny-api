package br.com.up.edestiny.api.exceptionhandler;
...
@ControllerAdvice
public class EdestinyExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private List<Erro> criarListaDeErros(BindingResult bindingResult) {
		...
		for (FieldError item : bindingResult.getFieldErrors()) {
			...
			String mensagemDev = item.toString();
